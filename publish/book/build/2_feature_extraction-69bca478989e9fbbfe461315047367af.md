...
The most significant challenge is variation in word forms. "Cat" and "cats" refer to the same concept but produce different tokens. "Go", "goes", "went", and "going" all share a meaning. The next subsection addresses this through stemming and lemmatization. [Figure %s](#fig-tokenization-process) shows the tokenization step applied to a document collection.
