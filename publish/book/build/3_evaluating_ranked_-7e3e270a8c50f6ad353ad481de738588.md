...
The shaded area under the curve represents Average Precision (AP), which the next subsection defines formally. The figure marks R-precision at rank $R$, where $R$ is the number of relevant documents. At this cutoff, precision and recall are numerically equal because both divide the number of relevant documents retrieved in the first $R$ positions by $R$.
...
| Atwood books | 2 | 0.833 | 1.000 |
| Russian novels | 1 | 0.000 | 1.000 |

$$MAP_A = \frac{0.473 + 0.587 + 0.833 + 0.000}{4} = 0.473$$
...
[Open notebook ->](https://github.com/roger-weber/mmir-unibasel-hs26/blob/main/demos/ch02-01-retrieval-metrics.ipynb)
