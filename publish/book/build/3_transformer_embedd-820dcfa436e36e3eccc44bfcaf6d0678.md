...
1. **Tokenization**: the text is split into sub-word tokens using algorithms like BPE or WordPiece (covered in [Chapter 3](#)). For example, "playing" becomes ["play", "##ing"]. This produces a sequence of token IDs from a fixed vocabulary (typically 30k-50k tokens).
