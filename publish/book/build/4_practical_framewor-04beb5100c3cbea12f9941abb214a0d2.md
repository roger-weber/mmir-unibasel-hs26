...
The `explain` output decomposes the score into each clause's contribution, showing the IDF, TF, field length, boost, and normalization parameters. This makes it possible to diagnose why a document ranks where it does and to tune field boosts accordingly.
