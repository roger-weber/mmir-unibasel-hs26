...
|----------|-----------|--------|-------|----------|
| A | BM25 | none | Any | Fast keyword retrieval via inverted index. Misses semantic matches. |
...
This chapter focuses on the models behind these components: how bi-encoders generate embeddings for retrieval, how cross-encoders score relevance for reranking, and what tradeoffs determine which pipeline to choose. The efficient indexing and search of dense vectors is the subject of [Chapter 6 (Vector Search)](#).
