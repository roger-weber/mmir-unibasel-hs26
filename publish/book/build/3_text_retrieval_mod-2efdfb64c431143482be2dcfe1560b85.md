...
The remaining question is how to combine the atomic scores. The p-norm model interprets soft AND as closeness to the ideal point $(1,\ldots,1)$ and soft OR as distance from $(0,\ldots,0)$.
