...
:class: seealso
- [Classical Text Retrieval (Ch. 1)](#classical-text-retrieval): TF-IDF weighting, cosine similarity, the vector space model
- [Advanced Text Processing (Ch. 3)](#advanced-text-processing): tokenization, subword segmentation (BPE, WordPiece)
- [Indexing for Text Retrieval (Ch. 4)](#indexing-for-text-retrieval): inverted index, BM25 scoring
