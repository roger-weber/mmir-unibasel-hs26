...
[Figure %s](#fig-text-retrieval-timeline) traces this six-decade evolution, from Salton's SMART system through BM25 to its current role as the fast first-stage retriever in retrieval-augmented generation pipelines. The optional reading below describes each milestone.
