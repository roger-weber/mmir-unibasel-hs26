...
$$\text{score} = \text{boost} \cdot \text{idf} \cdot \frac{\text{tf}\cdot (k_1 + 1)}{\text{tf} + k_1\cdot \left(1 - b + b\,\dfrac{dl}{avgdl}\right)}, \quad \text{idf} = \log\left(1 + \frac{N - n + 0.5}{n + 0.5}\right).$$
