...
```{hint} Hands-on: Query Understanding
Run POS tagging and NER on a set of natural-language queries, extract candidate entities, and compare the `spaCy` and `nltk` outputs.

[Open notebook ->](https://github.com/roger-weber/mmir-unibasel-hs26/blob/main/demos/ch03-04-query-understanding.ipynb)
