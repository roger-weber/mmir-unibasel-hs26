...
| 3 | 2/3 = 66.7% | 3/3 = 100% |
| 5 | 2/5 = 40.0% | 4/5 = 80.0% |
| 10 | 5/10 = 50.0% | 6/8 = 75.0%* |

*System B returns only 8 documents. Positions 9 and 10 are empty, counted as non-relevant when computing $P@10$.
```
...
| Stage plays | 5 | 0.722 | 0.750 |
| Atwood books | 2 | 0.750 | 1.000 |
| Russian novels | 1 | 0.000 | 1.000 |

$$MAP_A = \frac{0.473 + 0.722 + 0.750 + 0.000}{4} = 0.486$$

$$MAP_B = \frac{0.359 + 0.750 + 1.000 + 1.000}{4} = 0.777$$

System B wins on MAP despite finding far fewer relevant documents on the largest need. Three factors combine: B has perfect or near-perfect AP on three smaller needs, while A's single zero on Russian novels (it returns three French/German works instead) costs 0.25 in the average.
```
