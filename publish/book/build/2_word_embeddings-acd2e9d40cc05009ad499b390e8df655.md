...
The training objective maximizes the probability of observed context words across the entire corpus. Equivalently, we minimize the negative log-likelihood over all windows:
