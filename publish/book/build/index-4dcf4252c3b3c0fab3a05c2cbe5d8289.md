...
:name: fig-ir-history-opac
:width: 80%

From manual reference desk assistance to menu-driven catalog terminals: information retrieval before the web.
```
...
:name: fig-classical-to-neural
:width: 90%

From classical keyword search (left) through learned ranking models (center) to the deep learning foundations that enable neural retrieval (right).
```
...
The four stages in the table above emerged over six decades of research, from the first experiments with computerized catalogues in the 1960s to today's transformer-based systems.
