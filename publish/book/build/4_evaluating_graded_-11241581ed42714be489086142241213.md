...
The discounting makes the rank-2 position visible: System A's grade-2 book at rank 2 contributes $2 \times 0.631 = 1.262$, while B's grade-3 book at the same rank contributes $3 \times 0.631 = 1.893$. Same position, different grade, different credit. CG would sum both into the total without distinguishing where they appeared.
```
