...
```{admonition} Source formats and extraction tools (optional reading)
:class: note dropdown
...
```{admonition} Key Formula: **tf·idf** document representation
:class: important
