...
In code this is remarkably direct: an inverted index is a dictionary from terms to postings sets, and the Boolean operators are the language's own set operators. Taking a slightly larger example collection:
