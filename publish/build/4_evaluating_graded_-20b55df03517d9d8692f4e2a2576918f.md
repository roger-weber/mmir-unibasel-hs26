...
The gap is even wider than with CG because B's grade-3 books sit at ranks 1 and 2, where the discount is smallest. System A's grade-2 book at rank 2 contributes $2 \times 0.631 = 1.262$, while B's grade-3 at the same rank contributes $3 \times 0.631 = 1.893$.
```
