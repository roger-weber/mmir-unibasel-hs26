...
- Manning, Raghavan, Schütze (2008). *Introduction to Information Retrieval*. — The standard graduate textbook; chapters 1–6 cover Boolean, VSM, and probabilistic models with rigorous treatment. Freely available online.

- Robertson & Zaragoza (2009). *The Probabilistic Relevance Framework: BM25 and Beyond*. — Definitive survey of BM25's theoretical foundations and practical extensions.

- Salton, Wong & Yang (1975). *A Vector Space Model for Automatic Indexing*. — The original paper introducing VSM; still readable and surprisingly concise.

- Spärck Jones (1972). *A Statistical Interpretation of Term Specificity and Its Application in Retrieval*. — Introduced IDF; foundational for all term weighting schemes.

- Porter (1980). *An Algorithm for Suffix Stripping*. — The classic stemming algorithm still used as a baseline in English text processing.
