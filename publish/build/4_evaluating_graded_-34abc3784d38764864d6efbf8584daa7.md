...
The right metric depends on the information need. A patent lawyer conducting an exhaustive prior-art search needs high recall and should evaluate with AP or MAP. A web search user or fact-checker who reads three results and moves on cares about nDCG@10 or nDCG@5. A recall-oriented first stage in a retrieval pipeline might use nDCG@100 or nDCG@1000 to measure whether relevant material reaches the re-ranker.
```
